// Manual additions missing from makeqstrdata.py

QDEF(MP_QSTRnull, (const byte*)"\x00\x00" "")
QDEF(MP_QSTR___aiter__, (const byte*)"\x00\x00" "")
QDEF(MP_QSTR___anext__, (const byte*)"\x00\x00" "")
QDEF(MP_QSTR___aenter__, (const byte*)"\x00\x00" "")
QDEF(MP_QSTR___aexit__, (const byte*)"\x00\x00" "")
QDEF(MP_QSTR_StopAsyncIteration, (const byte*)"\x00\x00" "")
